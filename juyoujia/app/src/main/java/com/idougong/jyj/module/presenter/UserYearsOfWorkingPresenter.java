...
import com.idougong.jyj.module.contract.UserYearsOfWorkingContract;
...
public class UserYearsOfWorkingPresenter extends BasePresenter<UserYearsOfWorkingContract.View> implements UserYearsOfWorkingContract.Presenter {
    @Inject
    ApiService apiService;

    @Inject
    public UserYearsOfWorkingPresenter() {
    ...
    @Override
    public void getUpdateUserInfoResult(String cpYear) {
        Map<String, Object> objectMap = new HashMap<>();
        if (!EmptyUtils.isEmpty(cpYear)) {
            objectMap.put("cpYear", cpYear);
        }
